...
#docker-compose -f docker-compose-api.yaml ps
docker-compose -f docker-compose-api.yaml run --rm -e TYPE="@API" -u ${HOST_UID_GID} -v $HOME/.m2:/root/.m2 -w /var/jenkins_home/workspace/maven-6 --entrypoint="./runner-api.sh" api-test-service
